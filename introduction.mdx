...
<CardGroup cols={2}>
  <Card title="Mask" icon="mask" href="/packages/mask">
    An SVG intelligent mask that cover all the contents except the part
    specified
  </Card>
  <Card title="Popover" icon="window-restore" href="/packages/popover">
    A popover positioned based on certain values
  </Card>
</CardGroup>
<CardGroup cols={1}>
  <Card title="Tour" icon="bus-simple" href="/packages/tour">
